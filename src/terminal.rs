...
pub const FONT_BPG:u8       = 8;   // Bytes per glyph
pub const FONT_BPL:u32       = 1;   // Bytes per line
pub const FONT_NUMGLYPHS:u8 = 224;
pub const FONT_SIZE:u32      = 1;

pub const font:[[u8;FONT_BPG as usize];FONT_NUMGLYPHS as usize] = [
